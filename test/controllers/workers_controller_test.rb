...
class WorkersControllerTest < ActionController::TestCase
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post :create, worker: { address: @worker.address, email: @worker.email, name: @worker.name, phone: @worker.phone }
    end
  ...
  test "should update worker" do
    patch :update, id: @worker, worker: { address: @worker.address, email: @worker.email, name: @worker.name, phone: @worker.phone }
    assert_redirected_to worker_path(assigns(:worker))
  end
